...
const sizes = [
    ...
    },
    {
        id: 9,
        from: '1 %',
        to: 'relative to the parent element’s size',
        equal: true,
    },
    {
        id: 10,
        from: '1 vw',
        to: '1% of the viewport’s width',
        equal: true,
    },
    {
        id: 11,
        from: '1 vh',
        to: '1% of the viewport’s height',
        equal: true,
    },
]

// Pixel equivalents for units
const unitToPx = {
    px: 1,
    em: 16,
    rem: 16,
    ...
    cm: 37.8,
    mm: 3.78,
    vw: window.innerWidth / 100, // 1vw = viewport width / 100
    vh: window.innerHeight / 100, // 1vh = viewport height / 100
};
...
const UnitConverter = () => {
    ...
    // Format function: max 2 decimals, hide if .00
    ...
    return (
        <div id="converter-container">
            <div id="inpts">
                ...
                <span><ion-icon name="swap-horizontal-outline"></ion-icon></span>
            ...
            {
                fromValue ? <p>{fromValue} {fromUnit} = {convert()} {toUnit}</p> : <p>Write to input...</p>
            }
        </div>
    );
};
